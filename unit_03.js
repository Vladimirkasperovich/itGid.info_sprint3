...
function f3() {
  const a = +document.querySelector(".i-31").value;
  const b = +document.querySelector(".i-32").value;
  if (a > b) {
...
function f4() {
  const birthday = +document.querySelector(".i-4").value;
  if (birthday >= 18) {
...
function f7() {
  const firstInput = +document.querySelector(".i-71").value;
  const secondInput = +document.querySelector(".i-72").value;
  document.querySelector(".out-7").textContent = Math.pow(
    firstInput,
    secondInput
  );
}
...
function f13() {
  ...
  document.querySelector(".out-13").textContent = typeof input;
}
...
function f14() {
  const firstInput = +document.querySelector(".i-141").value;
  const secondInput = +document.querySelector(".i-142").value;
  const select = document.querySelector(".s-143").value;
  const out = document.querySelector(".out-14");

  if (select === "+") {
    out.textContent = firstInput + secondInput;
  } else if (select === "-") {
    out.textContent = firstInput - secondInput;
  } else if (select === "*") {
    out.textContent = firstInput * secondInput;
...
function f15() {
   const firstNum = +document.querySelector('.s-151').value;
   const secondNum = +document.querySelector('.s-152').value;
   const operations = document.querySelector('.s-153').value;
   const out = document.querySelector('.out-15');

   if (operations === '&&'){
      out.textContent = firstNum && secondNum;
   }else if (operations === '||'){
      out.textContent = firstNum || secondNum;
